...
use ModulesGarden\TSSGGSModule\Components\SubmitButton;
...
use ModulesGarden\TSSGGSModule\Core\Validation\ImplicitRule;
use ModulesGarden\TSSGGSModule\Packages\Samples\UI\Admin\Home\SimpleForm\Dropdowns\Clients;
...
{
    protected \ModulesGarden\TSSGGSModule\Components\Form\Builder\Builder $builder;
...
//        });
        ...
        $this->builder->createField(FormInputText\FormInputText::class, 'configoptions[dupa]', true)->addValidator(new class implements \ModulesGarden\TSSGGSModule\Core\Contracts\Validation\ImplicitRuleInterface {
            protected string $name = 'dupa_valid';
