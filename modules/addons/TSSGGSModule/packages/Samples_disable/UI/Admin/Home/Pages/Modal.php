...
use ModulesGarden\TSSGGSModule\Components\CancelButton;
use ModulesGarden\TSSGGSModule\Components\FormBuilder;
use ModulesGarden\TSSGGSModule\Components\SubmitButton;
use ModulesGarden\TSSGGSModule\Core\Components\Traits\AjaxTrait;


class Modal extends \ModulesGarden\TSSGGSModule\Components\Modal implements \ModulesGarden\TSSGGSModule\Core\Contracts\Components\AdminAreaInterface
{
    use AjaxTrait;
