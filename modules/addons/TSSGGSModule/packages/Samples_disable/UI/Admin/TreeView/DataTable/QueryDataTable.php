...
namespace ModulesGarden\TSSGGSModule\Packages\Samples\UI\Admin\TreeView\DataTable;
...
class QueryDataTable extends \ModulesGarden\TSSGGSModule\Components\DataTable\DataTable implements AdminAreaInterface, AjaxComponentInterface, AjaxOnLoadInterface
{
    ...
    public function loadHtml(): void
    {
        ...
        $button->onClick((new ModalLoad(new \ModulesGarden\TSSGGSModule\Packages\Samples\UI\Admin\DataTable\Modals\UserEdit()))->withParams([
            'xxx' => \ModulesGarden\TSSGGSModule\Core\Support\Facades\Request::get('ajaxData')['dupa'] ?? null
        ]));
