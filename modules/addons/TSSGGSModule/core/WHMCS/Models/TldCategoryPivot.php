...
class TldCategoryPivot extends EloquentModel
{
    ...
    {
        return $this->hasOne('ModulesGarden\TSSGGSModule\Core\WHMCS\Models\TldCategory', 'tld_id');
    }

    public function tld()
    {
        return $this->hasOne('ModulesGarden\TSSGGSModule\Core\WHMCS\Models\Tld', 'tld_id');
    }
}
