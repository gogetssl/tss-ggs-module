...
use ModulesGarden\TSSGGSModule\Core\Contracts\DataSetInterface;
use ModulesGarden\TSSGGSModule\Core\Contracts\QueryProviderInterface;
use ModulesGarden\TSSGGSModule\Core\DataProviders\QueryDataProvider\ColumnName;

class QueryDataProvider extends AbstractRecordsListDataProvider implements QueryProviderInterface
{
    use \ModulesGarden\TSSGGSModule\Core\Components\FallbackTraits\QueryDataProvider;
    ...
    public function getData()/*: \ModulesGarden\TSSGGSModule\Core\Contracts\DataSetInterface*/
    {
