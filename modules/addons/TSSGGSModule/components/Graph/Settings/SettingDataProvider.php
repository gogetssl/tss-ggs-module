...
use ModulesGarden\TSSGGSModule\Core\Models\ModuleSettings\ModuleSettings;
use ModulesGarden\TSSGGSModule\Core\Support\Facades\Request;
use ModulesGarden\TSSGGSModule\Core\UI\Widget\Forms\DataProviders\BaseModelDataProvider;
...
class SettingDataProvider extends BaseModelDataProvider
{
    ...
    {
        parent::__construct('\ModulesGarden\TSSGGSModule\Core\Models\ModuleSettings\ModuleSettings');
    }
