...
namespace ModulesGarden\Servers\TSSGGSModule\core;
...
class Smarty {
    ...
    function setTemplateDir($dir){
        if(is_array($dir))
        {
            throw new \Exception('Wrong Template Path');
        }
        self::I()->_templateDIR = $dir;
    }

    function view($template,$vars = [], $customDir = false){
    ...
    {
        $dir = Server::getModuleTemplatesDir();
        return self::I()->view($dir . '/' . $template, $vars);
    }
