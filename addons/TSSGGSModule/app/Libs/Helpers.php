...
namespace ModulesGarden\TSSGGSModule\App\Libs;
...
use ModulesGarden\TSSGGSModule\Core\WHMCS\Models\PaymentGateway;
...
use ModulesGarden\TSSGGSModule\Core\WHMCS\URL\Admin;
...
use ModulesGarden\TSSGGSModule\Packages\Product\Services\ConfigurableOptionsGroup;
...
class Helpers
{
    ...
    {
        logmodulecall("TSSGGSModule Debug Log", $action, $request, $response, $response);
    }
    ...
    {
        $products       = Product::where('servertype', 'TSSGGSModule')->get();
        $productOptions = [
            0 => 'all',
        ];
    ...
    public static function getChecksumData()
    {
        $rootDirs = [
            dirname(__DIR__, 2),
            dirname(__DIR__, 4) . '/servers/TSSGGSModule'
        ];

        $excludedDirs = [
            'modules/addons/TSSGGSModule/langs',
            'modules/addons/TSSGGSModule/storage',
            'modules/servers/TSSGGSModule/langs',
            'modules/servers/TSSGGSModule/storage'
        ];
