...
use ModulesGarden\TSSGGSModule\App\Models\Whmcs\Configuration;
...
//        }
        ...
        $nextStep->onClick(Action::redirect('addonmodules.php?module=TSSGGSModule&mg-page=configuration&mg-action=step3'));
