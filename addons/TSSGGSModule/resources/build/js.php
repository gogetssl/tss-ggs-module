...
use ModulesGarden\TSSGGSModule\Core\Components\AssetsBuilder;
use ModulesGarden\TSSGGSModule\Core\UI\View\JavaScriptLoader;

require_once dirname(__FILE__, 3) . '/vendor/autoload.php';

\ModulesGarden\TSSGGSModule\Core\ModuleConstants::initialize();

header('Content-Type: application/javascript');

$builder          = new AssetsBuilder();
$javascriptLoader = new JavaScriptLoader();
$moduleName       = \ModulesGarden\TSSGGSModule\Core\ModuleConstants::getModuleName();
