...
namespace ModulesGarden\TSSGGSModule\Core\Api;

use AltoRouter;
use Exception;
use ModulesGarden\TSSGGSModule\App\Libs\Exceptions\ApiException;
use ModulesGarden\TSSGGSModule\App\Libs\Exceptions\WhmcsApiException;
use ModulesGarden\TSSGGSModule\Core\ModuleConstants;
use ModulesGarden\TSSGGSModule\Core\Traits\IsDebugOn;
...
class Http
{
    ...
    {
        $classname = "\\ModulesGarden\\TSSGGSModule\\App\\Http\\Api\\{$classname}";
