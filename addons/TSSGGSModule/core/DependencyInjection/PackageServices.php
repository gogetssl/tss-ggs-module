...
namespace ModulesGarden\TSSGGSModule\Core\DependencyInjection;

use ModulesGarden\TSSGGSModule\Core\ModuleConstants;
use ModulesGarden\TSSGGSModule\Core\Packages\Config;
use ModulesGarden\TSSGGSModule\Core\Packages\Packages;
...
class PackageServices
{
    ...
    protected function getEnabledPackages(): array
    {
        ...
        {
            if (\ModulesGarden\TSSGGSModule\Core\Support\Facades\Config::get('packages.' . $package, false))
            {
    ...
    protected function registerConfig(Config $config, $package)
    {
        ...
        {
            \ModulesGarden\TSSGGSModule\Core\Support\Facades\Config::push('install.' . lcfirst($package), $config->get('config'));
        }
    }
