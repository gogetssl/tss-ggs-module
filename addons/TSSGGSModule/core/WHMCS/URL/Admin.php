...
class Admin
{
    public static function adminSummary(int $adminId, array $parameters = [])
    {
        ...
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::adminarea('configadmins.php', $parameters);
    }
    ...
    public static function clientSummary(int $clientId, array $parameters = [])
    {
        ...
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::adminarea('clientssummary.php', $parameters);
    }
    ...
    public static function clientServices(int $clientId, array $parameters = [])
    {
        ...
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::adminarea('clientsservices.php', $parameters);
    }
    ...
    public static function clientDomains(int $clientId, array $parameters = [])
    {
        ...
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::adminarea('clientsdomains.php', $parameters);
    }
    ...
    public static function invoices(int $invoiceId, array $parameters = [])
    {
        ...
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::adminarea('invoices.php', $parameters);
    }
    ...
    public static function tickets(int $ticketId, array $parameters = [])
    {
        ...
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::adminarea('supporttickets.php', $parameters);
    }
    ...
    public static function orders(int $orderId, array $parameters = [])
    {
        ...
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::adminarea('orders.php', $parameters);
    }
    ...
    public static function productConfig(int $productId, array $parameters = [])
    {
        ...
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::adminarea('configproducts.php', $parameters);
    }
    ...
    {
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::clientarea('dl.php', [
            'type' => $type,
            'id' => $id,
            'i' => $index
        ]);
    ...
    {
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::clientarea('includes/thumbnail.php', [
            "{$type}id" => $id,
            'i' => $index
        ]);
    }
    ...
    public static function deleteAttachmentUrl(int $id, int $index, int $ticketId, string $type): string
    {
        ...
        return \ModulesGarden\TSSGGSModule\Core\Routing\Url::generateUrl(\ModulesGarden\TSSGGSModule\Core\Routing\Url::getAdminFolderPath() . 'supporttickets.php', $params) . $token;
    }
}