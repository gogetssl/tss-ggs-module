...
use ModulesGarden\TSSGGSModule\Core\HandlerError\ErrorCodes\ErrorCodesLib;
...
trait ErrorCodesLibrary
{
    ...
    public function loadErrorCodes()
    {
        ...
        {
            $this->errorCodesAppHandler = new \ModulesGarden\TSSGGSModule\App\Helpers\ErrorCodesLib();
        }
    }
}
