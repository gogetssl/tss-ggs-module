...
namespace ModulesGarden\TSSGGSModule\Components\DataTable;

use ModulesGarden\TSSGGSModule\Core\Data\ToArrayTrait;
use ModulesGarden\TSSGGSModule\Core\DataProviders\AbstractRecordsListDataProvider;

class Column extends \ModulesGarden\TSSGGSModule\Core\DataProviders\Column implements \JsonSerializable
{
    use ToArrayTrait;
