...
namespace ModulesGarden\TTSGGSModule\App\UI\Admin\Reports\Index\DataTables\ProfitLoss\ArrayDataProvider;


use ModulesGarden\TTSGGSModule\App\Libs\Helpers;
use ModulesGarden\TTSGGSModule\App\UI\Admin\Reports\Index\DataTables\ProfitLoss\Forms\DownloadForm;
...
class DataTable extends \ModulesGarden\TTSGGSModule\Components\DataTable\DataTable implements AdminAreaInterface, AjaxComponentInterface
{
    ...
    protected function parseDataSetRecords(): void
    {
        ...
        $this->dataSet->setFieldModifier('grossProfit', function($fieldName, $row, $fieldValue) {
            return ($row['cost']) ? Helpers::formatSelectedCurrency($fieldValue) : "-";
        });
