...
namespace ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements\SubPages\DataTable;
...
use ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\DataTable\Buttons\UserCreate;
...
class DataTable extends \ModulesGarden\TTSGGSModule\Components\DataTable\DataTable implements AdminAreaInterface, AjaxComponentInterface
{
    ...
    {
        $clients  = Client::select('id', 'firstname', 'lastname', 'taxexempt', 'companyname');
