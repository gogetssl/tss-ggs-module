...
namespace ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements;
...
use ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements\ServiceDetails\ServiceDetails;
use ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements\ServiceInformation\ServiceInformation;
use ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements\SparklineGraphs\SparklinesGraphs;
use ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements\SubPages\DataTable\DataTable;
use ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements\Tabs\Tabs;
use ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements\Tiles\Tiles;
use ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements\TreeView\TreeView;
...
class Container extends \ModulesGarden\TTSGGSModule\Components\Container\Container implements AdminAreaInterface, ClientAreaInterface
{
    public function loadHtml(): void
    {
        try
        {
            ...
            $this->addElement(new \ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements\ListInfo\ListInfo());
            $this->addElement(new ServiceInformation());
            $this->addElement(new \ModulesGarden\TTSGGSModule\Packages\Samples\UI\Admin\ComplexElements\PageDescription\PageDescription());
